...
export const SLACK_ELEMENTS: Record<SettingKey, SlackElement> = {
  hideWorkspaceName: {
  ...
  hidePrivateChannels: {
    selector:
      '[data-qa-channel-sidebar-channel-type="private"] .p-channel_sidebar__name',
  ...
  hideExternalChannels: {
    selector:
      '[data-qa-channel-sidebar-shared-type="externally-shared"] .p-channel_sidebar__name',
    className: "slack-ui-hider-blur-external-channels",
  },
  hideStarredChannels: {
    selector:
      '[data-qa-channel-sidebar-is-starred="true"] .p-channel_sidebar__name',
  ...
  // Content
  hideMessages: {
    selector: ".c-message_kit__blocks, .p-rich_text_block, .c-message_kit__attachments, .c-message_attachment, .c-files_container, .c-file_gallery, .p-file_image_thumbnail__image, .p-message_gallery_image_file",
    className: "slack-ui-hider-blur-messages",
  },
  hideThreads: {
    selector: ".p-threads_view, [data-qa='threads-tab'], .p-threads_flexpane, .c-message__reply_bar",
    className: "slack-ui-hider-blur-threads",
  },
  hideReactions: {
    selector: '[data-qa="reactji"], [data-qa="reaction_bar"], .c-reaction, .c-reaction_bar, .c-message_kit__reaction_bar, .c-reaction_add',
